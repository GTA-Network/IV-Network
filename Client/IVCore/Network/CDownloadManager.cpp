...
{
	m_delta->DownloadFromSubdirectory("client_files", SharedUtility::GetAbsolutePath("client_resources/"), false, g_pCore->GetNetworkManager()->GetServerAddress(), new TransferCB, HIGH_PRIORITY, 0, 0);
}
